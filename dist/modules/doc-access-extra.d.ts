 ...
 * @returns {void}
 */
export declare const check_inv_html_elem: (html_elem: HTMLElement | undefined | null, msg: string) => void;
 ...
 * @returns {string}
 */
export declare const err_msg_finisher: (what: string, parent?: HTMLElement) => string;
